...
7. `docs/smoke-2026-05-10.md`, `docs/smoke-2026-05-10-workpc-vpn.md`, and `docs/smoke-2026-07-29.md` — production smoke evidence (gate results, MAC pinning, the F-007 reversal, the v0.2.2 bridge validation)
...
└── docs/
    ...
    ├── smoke-2026-07-29.md                         ← v0.2.2 home-PC bridge validation (post gvtv v0.8.9 bump)
