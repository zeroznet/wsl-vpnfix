...
**Phase C in active execution** as of 2026-05-10. Plan at `docs/superpowers/plans/2026-05-10-wsl-vpnfix-phase-c-audit-and-release.md`. `docs/THREAT-MODEL.md` and `docs/SECURITY-AUDIT.md` (17 findings) landed; master-spec rebase folded the Phase B addendum and dropped the v1.0 audit gate per C-D-1; addendum file deleted (recoverable from git history). `v0.2.0` tag still pending; C5 (post-tag CLAUDE.md status update) replaces this paragraph with the closed form.
